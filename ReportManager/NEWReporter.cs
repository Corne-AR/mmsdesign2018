...
{
    public static class NEWReporter
    {
        ...
        public static bool TransactionReport(Data.Transactions.Transaction trans)
        {
            try
            {
                ...
                if (mailed)
                {
                    ...
                    trans.Save("Transaction " + trans.ID + " Emailed to " + trans.Contact + " - " + trans.Email, true, true);
                }
        ...
        public static void Preview(ReportName Name) => Views.ReportWindow.ShowReport(Name, null);

        public static void Preview<T>(ReportName Name, T DataSource) => Views.ReportWindow.ShowReport(Name, DataSource, null);
        ...
        {
            if (Predicate != null) Views.ReportWindow.ShowReport(Name, Manager.GetDataList(Predicate), null);
            else Views.ReportWindow.ShowReport(Name, Manager.GetDataList(), null);
        }
        public static bool MailReport(object DataSource, ReportName ReportName, Data.Communications.Mail Mail)
        {
            try
            {
                return Views.ReportWindow.ShowReport(
                      ReportName,
                      DataSource,
                      Mail);
            }
