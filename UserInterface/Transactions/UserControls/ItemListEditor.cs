    ...
    public partial class ItemListEditor : UserControl
    {
        ...
        private void productListDataGridView_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (transaction.UseVat) product.PriceInVat = Math.Round(value * transaction.VatRate, 2);
                ...
                {
                    if (transaction.UseVat) product.PriceExVat = Math.Round(value / transaction.VatRate, 2);
